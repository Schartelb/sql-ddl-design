...
(
  ...
  artists INTEGER REFERENCES artist,
  producers INTEGER REFERENCES producer
);
...
(
  id SERIAL PRIMARY KEY,
  title TEXT NOT NULL,
  song_id INTEGER NOT NULL UNIQUE REFERENCES songs
);

INSERT INTO songs
  (title, duration_in_seconds, release_date, artists, producers)
VALUES
